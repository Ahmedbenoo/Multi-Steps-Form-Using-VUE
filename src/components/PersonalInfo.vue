<template>
    <form class="personal-info__form">
        ...
        <input type="text" v-model="name" placeholder="e.g. Ahmed Mahmoud Fathy" required @blur="validateName" :class="(validName + ' ' + (nameEmpty === 'required' ? 'input--required' : undefined))" >
        ...
        <input type="text" v-model="email" placeholder="e.g. ahmedfathybenoo@gmail.com" required @blur="validateEmail" :class="(validEmail  + ' ' +  (nameEmpty === 'required' ? 'input--required' : undefined))" >
        ...
        <input type="number" v-model="phone" placeholder="e.g. +2 01092313486" required @blur="validatePhone" :class="(validPhone + ' ' + (nameEmpty === 'required' ? 'input--required' : undefined))">
